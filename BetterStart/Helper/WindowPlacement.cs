...
namespace BetterStart.Helper
{
    ...
    public static class WindowPlacement
    {
        ...
        public static void LoadPlacement(this Window window)
        {
            ...
            try
            {
                var dir = Path.GetDirectoryName(Common.WindowPositionsPath) ?? "";
                if (!Directory.Exists(dir)) Directory.CreateDirectory(dir);

                var path = Common.WindowPositionsPath + className + ".pos";
                if (File.Exists(path))
                {
        ...
        public static void SavePlacement(this Window window)
        {
            ...
            try
            {
                ...
                File.WriteAllText(Common.WindowPositionsPath + className + ".pos", pos);
            }
            catch (Exception e)
            {
