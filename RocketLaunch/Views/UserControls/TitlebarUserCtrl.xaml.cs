...
namespace Calculator3D.Views.UserControls
{
    ...
    {
        public static readonly DependencyProperty BoundCurrentWindow = DependencyProperty.Register("BoundWindow",
            typeof(Window), typeof(TitlebarUserCtrl), new PropertyMetadata(WindowPropertyChanged));

        public static readonly DependencyProperty Minimizable = DependencyProperty.Register("EnableMinimize",
            typeof(bool), typeof(TitlebarUserCtrl), new PropertyMetadata(true, MinPropertyChanged));

        public static readonly DependencyProperty Maximizable = DependencyProperty.Register("EnableMaximize",
            typeof(bool), typeof(TitlebarUserCtrl), new PropertyMetadata(true, MaxPropertyChanged));

        public static readonly DependencyProperty Closable = DependencyProperty.Register("EnableClosable", typeof(bool),
            typeof(TitlebarUserCtrl), new PropertyMetadata(true, ClosePropertyChanged));

        public static readonly DependencyProperty TitleProperty = DependencyProperty.Register("TitleProperty",
            typeof(string), typeof(TitlebarUserCtrl), new PropertyMetadata(TitlePropertyChanged));

        public static readonly DependencyProperty IconProperty = DependencyProperty.Register("IconProperty",
        ...
        public static readonly DependencyProperty CheckBeforeCloseProperty =
            DependencyProperty.Register("CheckBeforeCloseProperty", typeof(bool), typeof(TitlebarUserCtrl),
        ...
        {
            get { return (Window) GetValue(BoundCurrentWindow); }
            set { SetValue(BoundCurrentWindow, value); }
        }

        public bool EnableMinimize
        {
            get { return (bool) GetValue(Minimizable); }
            set { SetValue(Minimizable, value); }
        }

        public bool EnableMaximize
        {
            get { return (bool) GetValue(Maximizable); }
            set { SetValue(Maximizable, value); }
        }

        public bool EnableClosable
        {
            get { return (bool) GetValue(Closable); }
            set { SetValue(Closable, value); }
        }
